...
- **v1.0.0-preview** (2026-01-19): 🚀 **重大架构升级** ✨ **最新版本**
  - **核心重构**: LLM工厂模式、缓存系统、数据源管理器全面升级
  - **代码优化**: 减少70%重复代码，提升可维护性
  - **Bug修复**: 修复Docker部署登录405错误、数据源降级机制
  - **测试完善**: 添加20+测试脚本和完整测试计划
  - **文档更新**: 新增测试计划、诊断报告、技术文档
  - **性能提升**: LLM缓存减少30-50% Token消耗
  - **技术指标**: 统一MA、RSI、MACD、BOLL计算
  - **研究员优化**: 合并Bull/Bear研究员，统一逻辑实现
