...
### 估值指标字段 (2026-02-12 新增)

| 中文名称 | Tushare 字段 | 说明 | 使用优先级 |
|---------|-------------|------|-----------|
| 市盈率TTM | `pe_ttm` | 滚动市盈率 | ⭐⭐⭐ 必须使用 |
| 市净率 | `pb` | 市净率 | ⭐⭐ 重要参考 |
| 市销率TTM | `ps_ttm` | 滚动市销率 | ⭐⭐⭐ 估值分析优先 |
| 市销率静态 | `ps` | 静态市销率 | ⭐ 备选参考 |
| 股息率TTM | `dv_ttm` | 近12个月股息率 | ⭐⭐⭐ 分红分析优先 |
| 股息率 | `dv_ratio` | 当前股息率 | ⭐⭐ 分红参考 |
| 总股本 | `total_share` | 总股本（万股） | ⭐⭐ 市值计算 |
| 流通股本 | `float_share` | 流通股本（万股） | ⭐⭐ 流动性分析 |
